...
class _RecommendedLectureState extends State<RecommendedLecture> {
  ...
  uploadLecture() async {
    ...
    RecommendedLectureModel dataModel = RecommendedLectureModel(
      name: name.text,
    ...
    try {
      ...
      isLoading = false;
      setState(() {});
      Fluttertoast.showToast(msg: 'recommended Lecture added successfully');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Add Recommended lecture YouTube"),
        centerTitle: true,
      ),
      body: Padding(
          ...
          content: Container(
            ...
            child: Column(
              children: [
                ...
                const     Text("Recommended Lecture Added",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 22),),
                const SizedBox(
                  height: 13,
                ),
                Container(

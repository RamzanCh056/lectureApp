...
class AddLecture extends StatefulWidget {
  AddLecture(this.topics ,this.currentIndex,{Key? key}) : super(key: key);
  ...
  uploadLecture() async {
    ...
    try {
      await FirebaseFirestore.instance
          .collection(widget.topics[widget.currentIndex].topics.toString())
          .doc('$id')
          ...
          content: Container(
            ...
            child: Column(
              children: [
                ...
                Container(
                  child: const Text(
                    "Lecture Added please click on close",textAlign: TextAlign.center,style: TextStyle( fontWeight: FontWeight.w500),),
                ),
              ],
            ),
          ),
